...
<p align="center">
  <img src="https://skillicons.dev/icons?i=java,kotlin,python,androidstudio,firebase,git,github,opencv" />
</p>

**Languages & Libraries:**  
`Java` • `Kotlin` • `Python` • `XML` • `NumPy` • `Pandas` • `Machine Learning`
...
## 🎨 Creative Skills
- 📷 Photography (Portrait, Nature, Cinematic)
- 🎬 Cinematic Videography
- ✂️ Video Editing (DaVinci Resolve, CapCut, Premiere Pro)
- 🎨 Color Grading
...
<p align="center">
  <img src="https://visitor-badge.laobi.icu/badge?page_id=kunaljit3006.kunaljit3006"/>
</p>
